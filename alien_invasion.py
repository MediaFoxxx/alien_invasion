...
class AlienInvasion:
    """Класс для управления поведением и ресурасми игры."""

    def __init__(self):
        """Иициализирует игру и создает игровые ресурсы."""
        pygame.init()
    ...
    def _update_bullets(self):
        """Обновляет позиции снарядов и уничтожает старые пули."""
        # Обновление позиции снарядов.
        self.bullets.update()

        # Удалене снарядов, снарядов вышедших за край экрана.
    ...
    def start_new_level(self):
        """Запуск нового уровня, повышенной сложности."""
    ...
    def _update_aliens(self):
        ...
        # Проверка коллизий "Ппришелец - корабль".
    ...
    def _fire_bullet(self):
        """Создание нового снаряда и включени его в группу bullets."""
